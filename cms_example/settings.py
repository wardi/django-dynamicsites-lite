...
SECRET_KEY = '+2=)phu&amp;p#f0(20+f2134k5t&amp;(wz)yme*x$14ym)j5l(g4fxtt'
...
TEMPLATE_DIRS = (
    os.path.join(PROJECT_DIR, 'sites/common/templates'),
    # site-specific template directories automatically appended
)
...
INSTALLED_APPS = (
    ...
    'dynamicsiteslite',
    'pages', # django-page-cms, a.k.a. gerbi cms
    'filebrowser', # django-filebrowser-no-grappelli
    'cms_example', # just to allow loading of fixtures/initial_data.json
)
...
PAGE_HIDE_SITES = True
PAGE_HIDE_ROOT_SLUG = False
PAGE_DEFAULT_TEMPLATE = 'page_templates/one_column.html'
PAGE_TEMPLATES = (
    ('page_templates/one_column.html', "One Column"),
    ('page_templates/two_column.html', "Two Column"),
)
PAGE_LANGUAGES = (('en', 'English'),)
